...
export const allMusic=createAsyncThunk('allMusic',async()=>{
    const response = await fetch("http://localhost:5000/MusicCds/allWithUsers ",{
        method:"get"
    });
    try{
...
export const musicCds = createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        .addCase(allMusic.pending,(state)=>{
            ...
            state.loading=false
            state.musicCdsDetail=action.payload.musicDetails
            state.seller=action.payload.sellers
